...
const translations = {
  en: {
    ...
    board: {
      ...
      deleteTaskMessage: 'Are you sure you want to remove this task?',
      ...
      labelWeekdays: 'Restrict to days (optional)',
      days: {
        sun: 'Sun',
        mon: 'Mon',
        tue: 'Tue',
  ...
  no: {
    ...
    board: {
      ...
      deleteTaskMessage: 'Er du sikker på at du vil fjerne denne oppgaven?',
      ...
      labelWeekdays: 'Begrens til dager (valgfritt)',
      days: {
        sun: 'Søn',
        mon: 'Man',
        tue: 'Tirs',
      ...
      onlyOn: 'Kun på ',
      copyTask: 'Kopier oppgave',
      copy: 'Kopier',
      taskCopied: 'Oppgave kopiert',
    },
    snapshot: {
